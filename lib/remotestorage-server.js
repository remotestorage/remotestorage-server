...
module.exports.prototype.storage = function(req, res) {
  this.requestsInstance.handleRequest(req, res, this.folderFormat, this.folderContentType);
};
module.exports.prototype.makeScopePaths = function(userName, scopes) {
  return this.scopesInstance.makeScopePaths(userName, scopes, this.rootScope);
};
